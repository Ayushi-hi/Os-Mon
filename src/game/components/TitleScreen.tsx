...
export default function TitleScreen() {
  ...
  useEffect(() => {
    ...
    showcaseIds.forEach((monIdx, i) => {
      ...
      const mat1 = new THREE.MeshLambertMaterial({ color: c1 })
      const mat2 = new THREE.MeshLambertMaterial({ color: c2 })
      ...
      // Eyes
      const eyeMat = new THREE.MeshLambertMaterial({ color: 0xffffff, emissive: 0x888888 })
